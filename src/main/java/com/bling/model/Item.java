...
public class Item {
    ...
    public Item(Integer id,  Integer categoryId, String name, String subtitle, String detail, Date createTime, Date updateTime, String size, String color, String length, String width, String higth, String weight, Integer price, Integer stock, Integer scaling, Integer x, Integer y, String mainImage, String subImages, String dresserImages) {
        this.id = id;
        ...
        this.x = x;
        this.y = y;
        this.mainImage = mainImage.split(",");
