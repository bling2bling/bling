...
<ul>
						...
						<div class="col1 col5">
						<img src="/img/me1.png" class="img-responsive" alt="">
						</div>
						<div class="clearfix"></div>
					</div>                  
				</div>				
...
<!--banner-->
	...
	<!--content-->
		<div class="content">
		   ...
		   <img src="/img/pi.jpg" class="img-responsive" alt=""/><div class="b-wrapper1 long-img"><p class="b-animate b-from-right    b-delay03 ">Lorem ipsum</p><label class="b-animate b-from-right    b-delay03 "></label><h3 class="b-animate b-from-left    b-delay03 ">Trendy</h3></div></a>

							&lt;!&ndash;-<a href="single.html"><img src="/img/pi.jpg" class="img-responsive" alt=""></a>&ndash;&gt;
						</div>
						<div class="col-2">
							<span>Hot Deal</span>
					...
					<div class="col-md-6 col-md1">
						<div class="col-3">
							<a href="single.html"><img src="/img/pi1.jpg" class="img-responsive" alt="">
							<div class="col-pic">
								<p>Lorem Ipsum</p>
								<label></label>
								<h5>For Men</h5>
						...
						<div class="col-3">
							<a href="single.html"><img src="/img/pi2.jpg" class="img-responsive" alt="">
							<div class="col-pic">
								<p>Lorem Ipsum</p>
								<label></label>
								<h5>For Kids</h5>
						...
						<div class="col-3">
							<a href="single.html"><img src="/img/pi3.jpg" class="img-responsive" alt="">
							<div class="col-pic">
								<p>Lorem Ipsum</p>
								<label></label>
								<h5>For Women</h5>
			...
			<div class="brand">
				<div class="col-md-3 brand-grid">
					<img src="/img/ic.png" class="img-responsive" alt="">
				</div>
				<div class="col-md-3 brand-grid">
					<img src="/img/ic1.png" class="img-responsive" alt="">
				</div>
				<div class="col-md-3 brand-grid">
					<img src="/img/ic2.png" class="img-responsive" alt="">
				</div>
				<div class="col-md-3 brand-grid">
					<img src="/img/ic3.png" class="img-responsive" alt="">
				</div>
				<div class="clearfix"></div>
			</div>
			<!--//brand-->
	...
	<div class="footer-middle">
				<div class="container">
					<div class="col-md-3 footer-middle-in">
						<a href="index.jsp"><img src="/img/log.png" alt=""></a>
