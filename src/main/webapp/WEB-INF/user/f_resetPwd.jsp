        ...
        <form method="post"  action="/user/forget_reset_password.do">
            <div class="col-md-6 login-do">
                ...
                <div class="login-mail22">
                    <input placeholder="请输入密码" required="" type="password" id="password" name="passwordNew">
                    <i  class="glyphicon glyphicon-lock"></i>
                </div>
                <div class="login-mail22">
                    <input placeholder="请重复密码" required="" type="password" id="password2" onblur="checkAccord()">
...
<script>
    function checkAccord(){
        var pwd1=$("input[name='passwordNew']");
        var pwd2=$("#password2");
